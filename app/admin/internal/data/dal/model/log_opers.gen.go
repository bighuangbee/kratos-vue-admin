...
type LogOper struct {
	...
	BusinessType int32          `gorm:"column:business_type;type:tinyint;not null;comment:0其它 1新增 2修改 3删除" json:"business_type"`
	...
	UserID       int64          `gorm:"column:user_id;type:bigint;not null;comment:用户id" json:"user_id"`
	...
	Latency      int32          `gorm:"column:latency;type:int;not null;comment:延迟" json:"latency"`
